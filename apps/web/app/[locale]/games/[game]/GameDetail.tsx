...
import { Heart, ShoppingCart, Download, Shield, Key, BadgeCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <div className="max-w-7xl mx-auto px-4 -mt-32 relative z-10">
          ...
          >
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-zinc-500 text-sm">{game.category}</span>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {features.map((feature) => (
                <div key={feature.label} className="bg-zinc-900 border border-zinc-800 rounded-lg p-3 flex items-center gap-2">
                  <feature.icon className="w-4 h-4 text-brand flex-shrink-0" />
                  <span className="text-zinc-300 text-xs">{feature.label}</span>
                </div>
              ))}
            </div>
            ...
            <div>
              ...
              <div className="bg-zinc-900 rounded-xl border border-zinc-800 divide-y divide-zinc-800">
                ...
                <DetailRow label={t("details.category")} value={game.category} />
                <DetailRow label={t("details.platform")} value={game.platform} />
              </div>
            </div>
          </motion.div>
        </div>
        ...
        {similarGames.length > 0 && (
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-6">{t("youMayAlsoLike")}</h2>
