...
import { ArrowLeft, ArrowRight, CreditCard, Lock, PackageOpen, Shield } from "lucide-react";
      ...
      <div className="min-h-[calc(100vh-80px)] bg-zinc-950">
        <div className="mx-auto max-w-5xl px-4 py-12">
          ...
          >
            ...
            <p className="mt-2 text-sm text-zinc-400">{t("empty.subtitle")}</p>
            <Link
              href="/"
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          >
            ...
            <div className="mt-4 space-y-3 border-b border-zinc-800 pb-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-zinc-400">{t("checkout.discount")}</span>
