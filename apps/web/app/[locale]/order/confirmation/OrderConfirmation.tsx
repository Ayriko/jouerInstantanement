      ...
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        >
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition={{ delay: 0.2, stiffness: 300, type: "spring" }}
          >
        ...
        >
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-white">{orderDate}</p>
            </div>
            <div>
        ...
        >
          ...
          <p className="mt-1 text-xs text-zinc-500">{t("delivery.info")}</p>
        </motion.div>
        ...
        >
          <div className="space-y-3 border-b border-zinc-800 pb-4">
            <div className="flex items-center justify-between text-sm">
              <span className="text-zinc-400">{t("payment.subtotal")}</span>
              <span className="text-zinc-300">{subtotal.toFixed(2)}€</span>
            </div>
            <div className="flex items-center justify-between text-sm">
              <span className="text-zinc-400">{t("payment.discount")}</span>
