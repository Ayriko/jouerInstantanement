  ...
  return (
    <div className="relative h-[500px] w-full overflow-hidden mb-12">
      ...
      <div className="absolute bottom-0 left-0 p-8 md:p-16 max-w-2xl">
        ...
        >
          <span className="bg-brand text-white text-xs font-bold px-2 py-1 rounded mb-4 inline-block uppercase">{t("highlightedGame.tag.trending")}</span>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="bg-zinc-800/80 backdrop-blur-sm px-4 py-2 rounded-lg border border-zinc-700">
              ...
              <span className="text-brand font-bold">-{featuredGame.discount}%</span>
            </div>
          </div>
        </motion.div>
      </div>
