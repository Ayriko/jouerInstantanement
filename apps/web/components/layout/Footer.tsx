                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li>
                                <a
                                    ...
                                    className="hover:text-brand transition-colors"
                                >
                                    {t('support.links.termsConditions')}
                                </a>
                            </li>
                            <li>
                                <a
